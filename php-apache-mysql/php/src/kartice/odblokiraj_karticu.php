...
<body>
    ...
    <form action="" method="post">
        <div class="form-group">
            ...
            <select class="form-control input-sm" id="select" name="kartica">
                <?php
                    ...
                    $sql = "SELECT Kartice.KarticaID , Kartice.uid_kartice, Zaposlenici.Ime,Zaposlenici.Prezime,Zaposlenici.OIB FROM Kartice INNER JOIN Zaposlenici ON Zaposlenici.ZaposlenikID=Kartice.ZaposlenikID WHERE Kartice.dopusten=false;";
        ...
        <input type="submit" name="submit" class="btn btn-success" value="Odblokiraj karticu">
    </form>
    <?php
        include('../data/config.php');
        ...
        if(isset($_POST['submit']))
        {
            ...
            $stmt = "UPDATE Kartice SET dopusten=true WHERE KarticaID = ?";
            if($stmt = mysqli_prepare($link,$stmt))
            {
                mysqli_stmt_bind_param($stmt, "s" ,$param_id);
                    ...
                    {
                        echo "Kartica uspjesno odblokirana";
                    }
                    else{
